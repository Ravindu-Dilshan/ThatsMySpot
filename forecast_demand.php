                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="collapse show" id="collapseCardExample3">
                            <div class="card-body">
                                <img src="python//1//stationary.jpg" class="img-fluid" alt="Data Chart"
                                    style="width:1500px;height:800px;">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="collapse show" id="collapseCardExample4">
                            <div class="card-body">
                                <img src="python//1//normal.jpg" class="img-fluid" alt="Stationary Chart"
                                    style="width:1500px;height:800px;">
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered userTable" id="dataTableReport" width="100%"
                                        ...
                                        <tbody>
                                            ...
                                            if (($file = fopen("python//1//foredata.csv", "r")) !== FALSE) 
                                            {
                                    ...
                                    //change path to the bat file
                                      if (isset($_GET["train"])){
                                        exec('c:\WINDOWS\system32\cmd.exe /c START  C:/Users/RUKE69/PycharmProjects/ThatsMySpotPython/reciveTrain.bat 0 1 1');
                                        echo ('<script>location = "forecast_demand.php"</script>');
                                      }
                                      elseif (isset($_GET["fore"])){
                                        exec('c:\WINDOWS\system32\cmd.exe /c START  C:/Users/RUKE69/PycharmProjects/ThatsMySpotPython/reciveFore.bat 0 0 1');
                                        echo ('<script>location = "forecast_demand.php"</script>');
                                      }
                                    ?>
                                </div>
